...
***Learning objectives***
This project was designed to test my ability to work with large datasets and build algorithms based on those datasets. I had to use the following concepts:
